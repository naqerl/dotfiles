...
(use-package
 ...
 (defun my/occur-buffer-visible-p ()
   (my/window-with-name-visible-p "*Occur*"))
 :custom
 (golden-ratio-auto-scale t)
 (golden-ratio-exclude-buffer-names '("*Occur*"))
 (golden-ratio-inhibit-functions '(my/occur-buffer-visible-p)))
#+end_src
