...
(use-package general
  ...
  (general-define-key
   ...
   "<f3>" '(vterm-toggle :wk "Toggle eshell")
...
(use-package dashboard
  ...
  (dashboard-startupify-list '(suzu/dashboard-insert-banner
...
(add-hook 'dashboard-after-initialize-hook '(lambda () (blink-cursor-mode -1)))
