...
--   },
--   config = function()
--     vim.keymap.set('n', '<leader>tc', require('obsidian').util.toggle_checkbox,
--       { silent = true, desc = '[T]oggle [C]heckbox' })
--     vim.keymap.set('n', '<leader>c', ":Telescope commands default_text=Obsidian<CR>",
--       { silent = true, desc = '[T]oggle [C]heckbox' })
--
...
--         vim.notify("Following ling " .. url)
--         -- vim.fn.jobstart({ "hyprctl", "dispatch", "workspace", "1" })
