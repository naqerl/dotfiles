...
M.opts = {
	...
	on_highlights = function(highlights, colors)
		...
		highlights.CursorLineNr = { bg = colors.bg_dim, fg = colors.blue, bold = true }
		...
		-- highlights.GitSignsAdd = { bg = colors.none, fg = colors.green }
		-- highlights.GitSignsAddLn = { bg = colors.none, fg = colors.green }
		-- highlights.GitSignsAddNr = { bg = colors.none, fg = colors.green }
		--
		-- highlights.GitSignsChange = { bg = colors.none, fg = colors.yellow }
		-- highlights.GitSignsChangeLn = { bg = colors.none, fg = colors.yellow }
		-- highlights.GitSignsChangeNr = { bg = colors.none, fg = colors.yellow }
		--
		-- highlights.GitSignsDelete = { bg = colors.none, fg = colors.red }
		-- highlights.GitSignsDeleteLn = { bg = colors.none, fg = colors.red }
		-- highlights.GitSignsDeleteNr = { bg = colors.none, fg = colors.red }
	end,
}
